...
<header>
    ...
    <a href="#" class="logo"><span>IU</span>Laundry</a>
    ...
    <nav class="navbar">
        ...
        <a href="#ambilpaket">ambil paket</a>
    </nav>
...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>Laundry and Dry <span>Cleaning Services</span></h3>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="info">
                ...
                <p> Seoul, Korea 1997 </p>
            </div>
        </div>

    </div>

    <h1 class="credit"> &copy; copyright @ 2022 by IU LAUNDRY </h1>
