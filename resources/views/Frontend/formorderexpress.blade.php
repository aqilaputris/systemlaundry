...
<!-- express section starts  -->

<section class="express" id="express" >


    <form action="{{url('/frontend/express')}}" method="POST" enctype="multipart/form-data">
    @csrf
        <h1 class="heading">Form Order Express</h1>
